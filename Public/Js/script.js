...
let prev= document.querySelector('.slick-prev').innerHTML =` <img src="../Public/image/left-arrow_left.png" alt="left_arrows" class="btn-size">`

let next= document.querySelector('.slick-next').innerHTML=` <img src="../Public/image/left-arrow_right.png" alt="right_arrows" class="btn-size" >`
